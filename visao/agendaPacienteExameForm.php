    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading text-center"><h4>Solicitar Exame</h4></div>
                <div class="panel-body">
                   ...
                   <?php } ?>
                    <form method="post" action="?area=agendaPacienteExameControle" id="form" name="form" enctype="multipart/form-data" class="form-group">
                            ...
                            <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-md-offset-1 col-md-5 form-group">
                                                <label for="cpf">CPF: *</label><!-- id do input = cpf -->
                                                    <input type="text" autocomplete="off" onkeypress="MascaraCPF(form.cpf)" placeholder="Ex:000.000.000-00" id="cpf" required maxlength="14" class="form-control" value="<?= $agendaPacienteExame->getOPessoa()->getCpf() ?>" name="cpf"><div id="cpfMessage"></div>
                                            </div>
                                            <div class="col-md-5 form-group">
                                                <label for="nome">Nome: *</label>
                                                <input autocomplete="off" id="nome" class="form-control" value="<?php echo $agendaPacienteExame->getOPessoa()->getNome() ?>" name="nome">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-offset-1 col-md-5 form-group">
                                                <label for="email">Email: </label>
                                                <input autocomplete="off" value="<?php echo $agendaPacienteExame->getOPessoa()->getEmail() ?>" id="email" name="email" type="email" maxlength="100" class="form-control"/>
                                            </div>
                                            <div class="col-md-5 form-group">
                                                <label for="telefone">Telefone: </label>
                                                <input onkeypress="MascaraTelefone(form.telefone)" autocomplete="off" placeholder="Ex:(00)000000-0000" maxlength="14" id="telefone" class="form-control" value="<?php echo $agendaPacienteExame->getOPessoa()->getTelefone() ?>" name="telefone">
                                            </div>
                                        </div>
                                    <div class="row">
                                        <div class="col-md-offset-1 col-md-5 form-group">
                                        <label for="exame_id">Exame: *</label>
                                            <select name="exame_id" id="exame_id" class="form-control" onchange="examePaciente()">
                                                <option selected="true" value="" required>Selecione</option>
                                                <?php 
                                                    foreach($oExames as $oExame){
                                                    ?>
                                                        <option value="<?php echo $oExame->getExame_id(); ?>">
                                                            <?php 
                                                                    echo utf8_encode($oExame->getOExame()->getNome());
                                                            ?>
                                                        </option>
                                                    <?php
                                                    }
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <select name="mes" required="true" id="mes" class="form-control" onchange="selectDiaExame(this.value,'dia')">
                                    ...
                                    <div class="row">
                                        <div class="col-md-offset-1 col-md-5">
                                            ...
                                            <select name="dia" required="true" id="dia" onchange="selectHorario(this.value,'horario')" class="form-control">
                                                <option selected="selected" value="">Selecione</option>
                                            </select>
                                        </div>
                                    </div><br>
