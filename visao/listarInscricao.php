            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-striped">
                        <caption><h4>Inscrições</h4></caption>
                        <thead>
                            <tr>
                                <th>N&ordm;</th>
                            ...
                            foreach ($oCurriculos as $oCurriculo) {
                                ?><tr>
                                    ...
                                    <td><?php
                                        ...
                                        ?></td>
                                    <td><?php
                                        if ($oCurriculo->getData_status() != null)
                                    ...
                                    <td>
                                        <form method="post" action="?area=inscricaoControle">
...
<?php } ?>
                    ...
                    <div>
                        ...
                        <div class="text-center">
                            ...
                            <form action="?area=inscricaoControle" method="post" target="_blank">
                                <input type="hidden" value="<?php echo isset($dataI)?$dataI:''; ?>" name="dataI" />
                                <input type="hidden" value="<?php echo isset($dataF)?$dataF:''; ?>" name="dataF" />
                                <input type="hidden" value="<?php echo isset($cargo)?$cargo:''; ?>" name="cargo_id" />
                                <input type="hidden" value="<?php echo isset($status)?$status:''; ?>" name="status" />
                                <button name="acao" type="submit" class="btn btn-success" value="imprimirListar">
                    ...
                    <nav class="text-center" aria-label="Page navigation">
                        <ul class="pagination background-color">
                            ...
                            for ($cont = 0; $cont < $_SESSION['numero_pag']; ++$cont) {
                                ...
                                ?><li><a href="?area=inscricaoControle&acao=btListar&pagina=<?php echo $cont ?>"><?php echo $cont + 1 ?></a></li> <?php }
                            ?>
                        </ul>
                    </nav>
                </div>
